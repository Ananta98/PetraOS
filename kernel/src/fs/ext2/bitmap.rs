...
/// Common Ext2 Bitmap manipulation and allocation utilities.
...
impl Ext2Bitmap {
    ...
    pub fn alloc_block(volume: &Ext2Volume) -> Result<u32, VfsError> {
        ...
        let bg_desc_offset = (bg_desc_table_block * volume.sb.block_size) as u64;
        ...
        let bit_idx = Self::alloc_free_bit(&mut bitmap_buf, volume.sb.blocks_per_group as usize)?;
        ...
        volume.reader.write_bytes(physical_block as u64 * block_size, &zero_buf)?;
    ...
    pub fn alloc_inode(volume: &Ext2Volume) -> Result<u32, VfsError> {
        ...
        let bit_idx = Self::alloc_free_bit(&mut bitmap_buf, volume.sb.inodes_per_group as usize)?;
