...
#[wrap_syscall]
pub fn sys_sched_getparam(pid: i32, param_ptr: UserPtr<SchedParam>) -> SyscallResult {
...
#[wrap_syscall]
pub fn sys_sched_setparam(pid: i32, param_ptr: UserPtr<SchedParam>) -> SyscallResult {
