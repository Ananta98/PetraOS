...
pub struct DeviceManager {
    ...
    by_name: BTreeMap<&'static str, Arc<Spinlock<Box<dyn Device>>>>,
}
...
impl DeviceManager {
    ...
    pub fn devices(&self) -> &[Arc<Spinlock<Box<dyn Device>>>] {
        &self.devices
    }
    ...
    pub fn get_by_name(
        &self,
        name: &'static str,
    ) -> Option<Arc<Spinlock<Box<dyn Device>>>> {
    ...
    pub fn get_by_type(
        &self,
        dev_type: DeviceType,
    ) -> Vec<Arc<Spinlock<Box<dyn Device>>>> {
        self.devices
            .iter()
